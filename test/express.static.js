...
describe('websico.static()', function () {
  describe('basic operations', function () {
    ...
    it('should require root path', function () {
      assert.throws(websico.static.bind(), /root path required/)
    })

    it('should require root path to be string', function () {
      assert.throws(websico.static.bind(null, 42), /root path.*string/)
    })
  ...
  describe('fallthrough', function () {
    ...
    describe('when true', function () {
      ...
      it('should fall-through when URL too long', function (done) {
        ...
        app.use(websico.static(root, { 'fallthrough': true }))
    ...
    describe('when false', function () {
      ...
      it('should 404 when URL too long', function (done) {
        ...
        app.use(websico.static(root, { 'fallthrough': false }))
        app.use(function (req, res, next) {
          res.sendStatus(404)
        })
  ...
  describe('redirect', function () {
    before(function () {
      ...
      this.app.use(websico.static(fixtures))
    })
  ...
  describe('setHeaders', function () {
    before(function () {
      this.app = websico()
      this.app.use(websico.static(fixtures, { 'setHeaders': function (res) {
        res.setHeader('x-custom', 'set')
      } }))
    })

    it('should reject non-functions', function () {
      assert.throws(websico.static.bind(null, fixtures, { 'setHeaders': 3 }), /setHeaders.*function/)
    })
  ...
  describe('when index at mount point', function () {
    before(function () {
      this.app = websico()
      this.app.use('/users', websico.static(fixtures + '/users'))
    })
  ...
  describe('when mounted', function () {
    before(function () {
      this.app = websico()
      this.app.use('/static', websico.static(fixtures))
    })
  ...
  describe('when mounted "root" as a file', function () {
    before(function () {
      this.app = websico()
      this.app.use('/todo.txt', websico.static(fixtures + '/todo.txt'))
    })
  ...
  describe('when responding non-2xx or 304', function () {
    it('should not alter the status', function (done) {
      ...
      app.use(websico.static(fixtures))
  ...
  describe('when index file serving disabled', function () {
    before(function () {
      this.app = websico()
      this.app.use('/static', websico.static(fixtures, { 'index': false }))
      this.app.use(function (req, res, next) {
        res.sendStatus(404)
      })
    })
...
function createApp (dir, options, fn) {
  ...
  app.use(websico.static(root, options))
