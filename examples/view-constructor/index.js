...
// register .md as an engine in websico view system
...
app.set('views', 'expressjs/websico');
...
app.get('/Readme.md', function(req, res){
  // rendering a view from https://github.com/expressjs/websico/blob/master/Readme.md
